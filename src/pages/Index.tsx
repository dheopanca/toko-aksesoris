...
const Index = () => {
  ...
  const categories = [
    { name: "Cincin", image: "https://images.unsplash.com/photo-1605100804763-247f67b3557e?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60", path: "/products?category=rings" },
    { name: "Kalung", image: "https://images.unsplash.com/photo-1599643477877-530eb83abc8e?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60", path: "/products?category=necklaces" },
    { name: "Anting", image: "https://images.unsplash.com/photo-1561172358-cabf9d846a3c?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60", path: "/products?category=earrings" },
    { name: "Gelang", image: "https://images.unsplash.com/photo-1611591437281-460bfbe1220a?ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60", path: "/products?category=bracelets" },
  ];
