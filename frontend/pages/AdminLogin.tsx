  ...
  const onSubmit = async (data: LoginFormValues) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Selamat datang di Panel Admin Rivisya",
        variant: "default",
      });
      ...
      <div className="max-w-md mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 italic">
            Masuk untuk mengelola toko Rivisya
          </p>
        </div>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Masukkan username admin" type="text" className="border-amber-200 focus-visible:ring-amber-400" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
