        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="flex flex-col">
                <span className="font-playfair text-xl font-semibold text-amber-800 tracking-wider leading-tight">Rivisya</span>
                <span className="text-xs text-amber-600 font-light tracking-widest">AKSESORIS</span>
              </div>
            </div>
          </Link>
          ...
          <div className="flex items-center space-x-1 md:space-x-4">
            ...
            {isAuthenticated ? (
              ...
              <Button asChild size="sm" variant="ghost" className="hover:text-amber-700">
            ...
            <Sheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen}>
              ...
              <SheetContent side="right" className="w-[240px] sm:w-[300px] bg-white">
                <div className="flex items-center py-4 mb-4">
                  ...
                  <div>
                    <span className="font-playfair text-lg font-semibold text-amber-800">Rivisya</span>
                  </div>
                </div>
